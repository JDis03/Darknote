...
fun EditorScreen(
    ...
    // false = edit mode (eye icon, BasicTextField), true = preview (pencil icon, MarkdownPreview)
    ...
    LaunchedEffect(snippetId) {
        ...
        titleField = TextFieldValue(
            text = loaded.title,
            selection = TextRange(loaded.title.length)
        )
        ...
        topBar = {
            TopAppBar(
                ...
                actions = {
                    ...
                    // Eye/pencil toggle: eye = edit mode (BasicTextField),
                    // pencil = preview mode (read-only MarkdownPreview).
                    // Only shown for markdown notes.
                    if (isMarkdown) {
            ...
            Column(
                ...
                BasicTextField(
                    ...
                    keyboardActions = KeyboardActions(
                        onNext = { runCatching { contentFocusRequester.requestFocus() } }
                    ),
